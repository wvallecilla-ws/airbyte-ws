...
import pytest
from source_i_auditor.source import IAuditorStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(IAuditorStream, "path", "v0/example_endpoint")
    mocker.patch.object(IAuditorStream, "primary_key", "test_primary_key")
    mocker.patch.object(IAuditorStream, "__abstractmethods__", set())


def test_request_params(patch_base_class):
    stream = IAuditorStream()
